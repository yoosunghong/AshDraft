 ...
 *
 * Thresholds / intervals / batch count come from UAshAILODSettings, the global project AI LOD
 * settings object shared with actor-based non-player heroes.
 */
UCLASS(config = Game)
...
private:
	...
	/** Copies the global AI LOD settings into the working fields once. */
	void ResolveConfig();
